            ...
            <section class="right">
                <table class="tblone">
                    ...
                    <tr>
                        ...
                        <td>
                        <?php echo "<a href='CRUD.php?action=update&id=".$value['id']."'>Edit</a>"; ?>
                        <?php echo "<a href='CRUD.php?action=delete&id=".$value['id']."' onClick='return confirm(\"Do you really want to Delete Data 😡\")'>Delete</a>"; ?>
                        </td>
                    </tr>
                   <?php } ?>
                </table>
